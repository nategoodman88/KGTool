<template>
  <q-page class="q-pa-md flex flex-center">
    <div class="text-center">
      <h1 class="h1">MACHINE DESIGN & BUILD</h1>
      <p>
        ...
        receive end-to-end direct support from the Design and Electrical
        Engineers from Design to Delivery. Once the Machine is assembled and
        rigorously tested, we deliver to your agreed to delivery while exceeding
